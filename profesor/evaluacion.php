        ...
        <div class="col-md-12">
          ...
          <div class="tile">
                    <div class="tile-tile-w-btn">
                        ...
                        <p><button class="btn btn-info icon-btn" onclick="editarEvaluacion(<?= $data['evaluacion_id']; ?>)"><i class="fa fa-edit">
                        </i>Editar Evaluacion</button> <button class="btn btn-danger icon-btn"  onclick="eliminarEvaluacion(<?= $data['evaluacion_id']; ?>)">
                        <i class="fa fa-delet"></i>Eliminar Evaluacion</button> <a class="btn btn-warning icon-btn" href="entregas.php?curso=?<?=$data['pm_id']; 
                        ?>&contenido=<?= $data['contenido_id']; ?>$eva=<?= $data['evaluacion_id']; ?>"><i class="fa fa-edit"></i>Ver Entregas</a> </p>
                    </div>
                    <div class="tile-body">
