 ...
 <aside class="app-sidebar">
   <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/usuario.jpg" width="65px"
       height="65px" alt="usuario images">
     <div>
   ...
   <ul class="app-menu">
     ...
     <li><a class="app-menu__item" href="lista_profesores.php"><i
           class="app-menu__icon fas fa-chalkboard-teacher"></i><span class="app-menu__label">Profesores</span></a></li>
     ...
     <li><a class="app-menu__item" href="lista_actividad.php"><i class="app-menu__icon fas fa-list-alt"></i><span
           class="app-menu__label">Actividad</span></a></li>
     <li><a class="app-menu__item" href="lista_profesor_materia.php"><i
           class="app-menu__icon fas fa-list-alt"></i></i><span class="app-menu__label">Profesor Materia</span></a></li>
     <li><a class="app-menu__item" href="lista_alumno_profesor.php"><i class="app-menu__icon fas fa-list-alt"></i><span
           class="app-menu__label">Alumno Profesor</span></a></li>
     <li><a class="app-menu__item" href="../salir.php"><i class="app-menu__icon fas fa-sign-out-alt"></i><span
